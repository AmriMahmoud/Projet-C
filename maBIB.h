...
RESULTAT* trouverTop3ClientsParAnnee(FILE *, int );
RESULTAT** creerTableauTop3ParAnnee(FILE *, int , int );
void afficherTableauTop3ParAnnee(RESULTAT** , int , int );
void libererTableauTop3ParAnnee(RESULTAT** , int , int );
